...
function closeSubtaskDraftEdit() {
    let newSubtaskContaier = document.getElementById("edit-new-subtask-container");
      ...
      <div id="edit-substasks-container" class="flex-column gap8px">
         ...
         <div id="subtask-relative-container">
            <div id="edit-new-subtask-container" onclick="addOrCloseSubtaskEdit()">
               <input type="text" id="edit-new-subtask-input" placeholder="Add new subtask" />
...
//     subtaskIconContainer.innerHTML = /*html*/ `
//         <div id="edit-close-icon-container" onclick="closeSubtaskDraft()"><img src="/img/addTask/close.png" alt="delete" id="close-subtask"></div>
//         <div class="border-subtask-container"></div>
//         <div id="edit-check-icon-container" onclick="addSubtask()"><img src="/img/addTask/check.png" alt="check" id="check-subtask"></div>`;
